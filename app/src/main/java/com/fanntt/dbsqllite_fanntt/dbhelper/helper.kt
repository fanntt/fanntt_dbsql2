package com.fanntt.dbsqllite_fanntt.dbhelper
...
class helper (context: Context) :
    ...
    fun addName(nama : String, nim : Int ,jurusan  : String){
    ...
    fun getalldataMahasiswa() : List<ModelMahasiswa>{
        ...
        while (cursor.moveToNext()){
            ...
            Log.d("Databasehelper", "Fetched ID : $id , namaMahasiswa : $namaMahasiswa")
    ...
    fun updateDataMahasiswa(mhs : ModelMahasiswa)
    {
        val db = readableDatabase
        val values = ContentValues().apply {
            put(NAMA_MAHASISWA, mhs.nama)
